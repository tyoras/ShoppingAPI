...
import static io.tyoras.shopping.user.repository.mongo.SecuredUserMongoConverter.FIELD_PASSWORD;
import static io.tyoras.shopping.user.repository.mongo.SecuredUserMongoConverter.FIELD_SALT;
import static io.tyoras.shopping.user.repository.mongo.SecuredUserMongoConverter.FIELD_SECURITY;
import static io.tyoras.shopping.user.repository.mongo.UserMongoConverter.FIELD_CREATED;
