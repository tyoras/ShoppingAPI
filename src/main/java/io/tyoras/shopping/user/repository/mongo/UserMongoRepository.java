...
import static io.tyoras.shopping.user.repository.UserRepositoryErrorMessage.PROBLEM_DELETE_USER;
import static io.tyoras.shopping.user.repository.UserRepositoryErrorMessage.PROBLEM_READ_USER;
import static io.tyoras.shopping.user.repository.UserRepositoryErrorMessage.PROBLEM_SEARCH_USER;
import static io.tyoras.shopping.user.repository.UserRepositoryErrorMessage.PROBLEM_UPDATE_USER;
...
import static io.tyoras.shopping.user.repository.mongo.UserMongoConverter.FIELD_NAME;
import static io.tyoras.shopping.user.repository.mongo.UserMongoConverter.FIELD_PROFILE_VISIBILITY;
