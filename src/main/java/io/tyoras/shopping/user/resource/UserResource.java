...
import static io.tyoras.shopping.user.resource.UserResourceErrorMessage.INVALID_SEARCH;
import static io.tyoras.shopping.user.resource.UserResourceErrorMessage.USERS_NOT_FOUND;
